# ThetisLink v2.8.0 - Installation Guide
...
| ThetisLink-2.8.0.apk | ThetisLink Android Client - phone/tablet |
...
**Via file manager:**
1. Copy `ThetisLink-2.8.0.apk` to your phone (USB, email, or cloud)
