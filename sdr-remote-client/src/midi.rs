...
impl MidiAction {
    pub fn label(&self) -> &'static str {
        match self {
            Self::Ptt => "RX1 PTT",
            Self::VfoATune => "RX1 Frequency",
            Self::VfoBTune => "RX2 Frequency",
            Self::Vrx1Tune => "VRX1 Frequency",
            Self::Vrx2Tune => "VRX2 Frequency",
            Self::Radio1Tune => "Radio1 Frequency",
            Self::Radio2Tune => "Radio2 Frequency",
            Self::MasterVolume => "RX1 Master Volume",
            Self::VfoAVolume => "RX1 Volume",
            Self::VfoBVolume => "RX2 Volume",
            Self::Vrx1Volume => "VRX1 Volume",
            Self::Vrx2Volume => "VRX2 Volume",
            Self::TxGain => "TX Gain",
            Self::Drive => "Drive",
            Self::ModeCycle => "Mode Cycle",
            Self::BandUp => "RX1 Band Up",
            Self::BandDown => "RX1 Band Down",
            Self::Rx2BandUp => "RX2 Band Up",
            Self::Rx2BandDown => "RX2 Band Down",
            Self::Radio1BandUp => "Radio1 Band Up",
            Self::Radio1BandDown => "Radio1 Band Down",
            Self::Radio2BandUp => "Radio2 Band Up",
            Self::Radio2BandDown => "Radio2 Band Down",
            ...
            Self::YaesuVolume => "Radio1 Volume",
            Self::Radio2Volume => "Radio2 Volume",
            Self::YaesuRfGain => "Radio1 RF Gain",
            Self::YaesuMicGain => "Radio1 Mic Gain",
            Self::YaesuPtt => "Radio1 PTT",
            Self::Radio2Ptt => "Radio2 PTT",
        }
    }
    ...
    pub fn config_key(&self) -> &'static str {
        match self {
            ...
            Self::Vrx1Tune => "vrx1_frequency",
            Self::Vrx2Tune => "vrx2_frequency",
            Self::Radio1Tune => "radio1_frequency",
            Self::Radio2Tune => "radio2_frequency",
            Self::MasterVolume => "master_volume",
            Self::VfoAVolume => "vfo_a_volume",
            Self::VfoBVolume => "vfo_b_volume",
            Self::Vrx1Volume => "vrx1_volume",
            Self::Vrx2Volume => "vrx2_volume",
            Self::TxGain => "tx_gain",
            Self::Drive => "drive",
            Self::ModeCycle => "mode_cycle",
            Self::BandUp => "band_up",
            Self::BandDown => "band_down",
            Self::Rx2BandUp => "rx2_band_up",
            Self::Rx2BandDown => "rx2_band_down",
            Self::Radio1BandUp => "radio1_band_up",
            Self::Radio1BandDown => "radio1_band_down",
            Self::Radio2BandUp => "radio2_band_up",
            Self::Radio2BandDown => "radio2_band_down",
    ...
    pub fn from_config_key(key: &str) -> Option<Self> {
        match key {
            "ptt" => Some(Self::Ptt),
            "vfo_a_tune" | "rx1_frequency" => Some(Self::VfoATune),
            "vfo_b_tune" | "rx2_frequency" => Some(Self::VfoBTune),
            "vrx1_frequency" => Some(Self::Vrx1Tune),
            "vrx2_frequency" => Some(Self::Vrx2Tune),
            "radio1_frequency" => Some(Self::Radio1Tune),
            "radio2_frequency" => Some(Self::Radio2Tune),
            "master_volume" => Some(Self::MasterVolume),
            "vfo_a_volume" | "rx1_volume" => Some(Self::VfoAVolume),
            "vfo_b_volume" | "rx2_volume" => Some(Self::VfoBVolume),
            "vrx1_volume" => Some(Self::Vrx1Volume),
            "vrx2_volume" => Some(Self::Vrx2Volume),
            "tx_gain" => Some(Self::TxGain),
            "drive" => Some(Self::Drive),
            "mode_cycle" => Some(Self::ModeCycle),
            "band_up" | "rx1_band_up" => Some(Self::BandUp),
            "band_down" | "rx1_band_down" => Some(Self::BandDown),
            "rx2_band_up" => Some(Self::Rx2BandUp),
            "rx2_band_down" => Some(Self::Rx2BandDown),
            "radio1_band_up" => Some(Self::Radio1BandUp),
            "radio1_band_down" => Some(Self::Radio1BandDown),
            "radio2_band_up" => Some(Self::Radio2BandUp),
            "radio2_band_down" => Some(Self::Radio2BandDown),
            ...
            "yaesu_volume" | "radio1_volume" => Some(Self::YaesuVolume),
            "radio2_volume" => Some(Self::Radio2Volume),
            "yaesu_rf_gain" => Some(Self::YaesuRfGain),
            "yaesu_mic_gain" => Some(Self::YaesuMicGain),
            "yaesu_ptt" | "radio1_ptt" => Some(Self::YaesuPtt),
            "radio2_ptt" => Some(Self::Radio2Ptt),
            _ => None,
        }
    }
