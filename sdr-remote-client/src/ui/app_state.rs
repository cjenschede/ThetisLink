...
impl SdrRemoteApp {
    pub fn new(
        ...
        let mut app = Self {
            ...
            yaesu_latches: [sdr_remote_logic::ptt_intent::Latches::default(); 2],
            yaesu_ptt_last_sent: [false; 2],
            multi_tx: config.multi_tx,
            ptt_blocked_by_own: false,
            yaesu_blocked_by_own: [false; 2],
            thetis_want: false,
            ptt_blocked_at: None,
            yaesu_blocked_at: [None; 2],
