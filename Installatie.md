# ThetisLink v0.7.0 - Installatiehandleiding
...
| ThetisLink-0.7.0.apk | Android client - telefoon/tablet |
...
**Via bestandsbeheer:**
1. Kopieer `ThetisLink-0.7.0.apk` naar je telefoon (USB, e-mail, of cloud)
