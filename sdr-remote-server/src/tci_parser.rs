...
pub fn parse_tci_text(cmd: &str) -> Option<TciNotification> {
    ...
    match name {
        ...
        "rx_channel_sensors_ex" => {
            ...
            // Use avgdBm (field 3) = WDSP time-domain RMS average (AVG_SIGNAL_STRENGTH).
            // This matches Thetis avg S-meter: integrates all power in the passband.
            // peakBinDbm (field 4) is just the single highest FFT bin — too low for noise.
